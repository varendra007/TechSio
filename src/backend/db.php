<?php
    ...
    $sql5 = mysqli_query($conn,"CREATE TABLE `mydb1`.`user_info` ( `id` INT NOT NULL ,  `user_id` INT(255) NOT NULL ,  `status` VARCHAR(200) NOT NULL ,  `education` VARCHAR(200) NOT NULL ,  `address` VARCHAR(300) NOT NULL ,  `website` VARCHAR(500) NOT NULL ,  `hobbies` VARCHAR(400) NOT NULL, `cover_image` VARCHAR(400) NOT NULL ) ENGINE = InnoDB");
$conn->close();
?>