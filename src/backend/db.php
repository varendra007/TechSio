<?php
    ...
    $sql3 = mysqli_query($conn,"CREATE TABLE `chat`.`posts` ( `post_id` INT NOT NULL ,  `user_id` INT(255) NOT NULL ,  `image` VARCHAR(255) NOT NULL ,  `likes` INT NOT NULL ,  `comment` VARCHAR(200) NOT NULL ,  `date` DATE NOT NULL ) ENGINE = InnoDB");
